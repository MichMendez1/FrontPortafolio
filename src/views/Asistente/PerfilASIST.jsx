...
const PerfilAsist = () => {
  ...
  const { nombre, apellido_paterno, apellido_materno, email, direccion, telefono, tipo, genero, id_colegio } = user || {}
  return (
            ...
            <MDBCard className="mb-3" style={{ borderRadius: '.5rem' }}>
              <MDBRow className="g-0">
                <MDBCol md="4" className="gradient-custom text-center text-white"
                  ...
                  <MDBTypography tag="h5">{nombre} {apellido_paterno} {apellido_materno}</MDBTypography>
                ...
                <MDBCol md="8">
                  <MDBCardBody className="p-4">
                    ...
                    <MDBRow className="pt-1">
                      ...
                      <MDBCol size="6" className="mb-3">
                        <MDBTypography tag="h6">Codigo de Colegio</MDBTypography>
                        <MDBCardText className="text-muted">{id_colegio}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
